##########################################################################
# Luis Pena, CS 2318-002, Assignment 2 Part 1 Program B
############################ data segment ################################
		.data
...
main:
		...
		andi	$t1, $t1, 0x20	#and $t1 input with binary number 0010000
		
		andi	$t2, $t2, 0x20	#and $t2 input with binary number 0010000
		...
		or	$t1, $t1, $t2	#or $t1 input and $t2 input and store in $t1
